...
<body style="background-color: #edf2f6">
                        ...
                        <div class="card card-weather">
                            <div class="card-body">
                                <div class="inputWeather">
                                    ...
                                    <div class="showCity1">
                                        <h1 id="cityName1"></h1>
                                        <span id="timeShow1" style="color: black; text-shadow: blueviolet;"></span>
                                        <br />
                                        <br />
                                    </div>
                                    ...
                                    <button id="load" class="btn btn-primary btn-sm" style="width: 100px; margin-left: 52px; margin-top: 30px">
                      <b>Load</b>
                    </button>
                                </div>
                            </div>
    ...
    <script>
        ...
        function fakeLoad() {
            var url =
                "https://api.openweathermap.org/data/2.5/weather?lat=43.7696&lon=11.2558&appid=0eb396a5cdcd36c58c23d755cea2208e&units=metric&mode=xml";
            $.get(url)
                .done((data) => {
                    console.log(data);
        ...
        function getWeather(lat, lon) {
            ...
            $.getJSON(url, function(data) {
                ...
                var windSpeed = data.wind.speed * 1.6;
        ...
        function getRealTime() {
            var d = new Date();
            document.getElementById("timeShow1").innerHTML = d;
        }
